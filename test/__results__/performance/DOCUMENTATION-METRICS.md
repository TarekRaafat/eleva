...
> **Version:** 1.2.0 | **Generated:** 2/8/2026, 10:58:11 AM | **Platform:** darwin arm64 | **Runtime:** Bun 1.3.8
...
| Hydration Time | 0.131 ms | **< 1** |
| DOM Update | 0.028 ms | **< 0.1** |
| Memory | < 0.5 MB | **< 0.5** |
...
|-------|------|
| ESM (raw) | 63.15 KB |
| UMD (minified) | 6.03 KB |
| UMD (min+gzip) | **2.38 KB** |
