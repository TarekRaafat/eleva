...
Focused, copy-paste ready solutions for common UI scenarios.
...
Full mini-applications demonstrating multiple features working together.

| App | Description | Link |
|-----|-------------|------|
| **Task Manager** | Filtering, sorting, priorities, localStorage | [View →](./apps/task-manager.md) |
| **Weather Dashboard** | API fetching, search history, unit conversion | [View →](./apps/weather-dashboard.md) |
| **Simple Blog** | Posts, comments, component composition | [View →](./apps/blog.md) |
...
### Apps
- [Task Manager](./apps/task-manager.md)
- [Weather Dashboard](./apps/weather-dashboard.md)
