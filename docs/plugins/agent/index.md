---
title: Eleva.js Agent Plugin - AI/Agent Integration
description: "Agent Experience (AX): Build agent-powered Eleva apps with the Agent plugin. Action registry, command bus, audit logging, permissions, and state inspection. Lightweight, typed, zero-config."
image: /imgs/eleva.js%20Full%20Logo.png
---

<link rel="canonical" href="https://elevajs.com/plugins/agent/">

<!-- Open Graph -->
<meta property="og:type" content="article">
<meta property="og:url" content="https://elevajs.com/plugins/agent/">
<meta property="og:title" content="Agent Plugin - Eleva.js">
<meta property="og:description" content="Agent Experience (AX): Build agent-powered Eleva apps with the Agent plugin. Action registry, command bus, audit logging, permissions, and state inspection. Lightweight, typed, zero-config.">
<meta property="og:image" content="https://elevajs.com/imgs/eleva.js%20Full%20Logo.png">
<meta property="og:site_name" content="Eleva.js">

<!-- Twitter Card -->
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:url" content="https://elevajs.com/plugins/agent/">
<meta name="twitter:title" content="Agent Plugin - Eleva.js">
<meta name="twitter:description" content="Agent Experience (AX): Build agent-powered Eleva apps with the Agent plugin. Action registry, command bus, audit logging, permissions, and state inspection. Lightweight, typed, zero-config.">
...
<script type="application/ld+json">
{
  ...
  "@type": "TechArticle",
  "headline": "Eleva.js Agent Plugin - AI/Agent Integration",
  "description": "Eleva.js Agent plugin for AI and agent integration. Action registry, command bus, audit logging, capability-based permissions, and state inspection.",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://elevajs.com/plugins/agent/"
  },
  "proficiencyLevel": "Intermediate",
  "articleSection": "Plugins",
  "keywords": ["eleva", "elevajs", "Eleva.js", "agent plugin", "AI integration", "action registry", "command bus", "audit log", "permissions", "agent experience", "AX", "LLM integration", "AI framework"]
}
</script>
...
<script type="application/ld+json">
{
  ...
  "name": "Eleva Agent",
  "alternateName": ["@eleva/agent", "eleva-agent", "Eleva.js Agent"],
  "description": "AI and agent integration plugin for Eleva.js. Action registry with schemas, structured command bus, audit logging, capability-based permissions, and state inspection for building agent-powered applications.",
  "url": "https://elevajs.com/plugins/agent/",
  "applicationCategory": "DeveloperApplication",
  "applicationSubCategory": "JavaScript AI/Agent Plugin",
  ...
  "featureList": [
    "Action registry with schemas",
    "Batch and sequential execution primitives",
    "Structured command bus",
    "Audit logging with outcomes and rotation",
...
<script type="application/ld+json">
{
  ...
  "name": "Eleva Agent - AI-Powered Component Example",
  "description": "Practical example showing action registration, command dispatch, and audit logging for building agent-powered interactive components with Eleva.js.",
  "programmingLanguage": {
  ...
  "teaches": ["Action registry", "Command bus", "Audit logging", "AI integration", "Permissions"]
}
</script>
...
> _Eleva's Agent plugin is the **AX** (Agent Experience) layer — a first-class integration surface for LLMs, AI agents, and automation scripts._
...
- **AI-powered applications** — Register actions as LLM tools with typed schemas so AI models can discover and call them. See [LLM-Powered Agent pattern](./patterns.md#llm-powered-agent).
- **Decoupled component communication** — Components register services (e.g., `"getUsers"`, `"addToCart"`) that other components call by name, without importing or prop-drilling. See [Cross-Component Messaging pattern](./patterns.md#cross-component-messaging).
- **Command-driven UI** — Toolbar sends `"REFRESH"` or `"TOGGLE_SIDEBAR"` commands; any component can handle them independently. See [Command-Driven UI pattern](./patterns.md#command-driven-ui).
- **Debugging and auditing** — Every action execution, command dispatch, and (optionally) store/router event is recorded in a queryable audit log with timestamps. See [Audit Dashboard pattern](./patterns.md#audit-dashboard).
- **Multi-agent coordination** — Scope-based permissions control which agents can execute which actions, with strict mode for production safety. See [Scoped Permissions pattern](./patterns.md#scoped-permissions).
- **Application introspection** — Snapshot component state, diff changes over time, and inspect the component tree at runtime. See [State Inspection pattern](./patterns.md#state-inspection).
...
> Use `${ctx.property.value}` in templates with `template: (ctx) => \`...\``.
...
| Section | Description |
|---------|-------------|
| [Usage Patterns](./patterns.md) | Action registry, command bus, cross-component, and AI agent examples |
| [Machine-Readable Manifest](/agent-manifest.json) | Structured JSON for AI tool-calling integrations |
| [API Reference](./api.md) | Complete API, troubleshooting, TypeScript types, and migration guide |
...
- [Usage Patterns](./patterns.md) — Real-world examples with action registry, commands, and AI agents
- [API Reference](./api.md) — Complete method reference, TypeScript types, and troubleshooting

---

## Related Documentation

- [Store Plugin](../store/) — Centralized state management (works alongside Agent)
- [Router Plugin](../router/) — Client-side routing and navigation
- [Custom Plugin Guide](../../examples/custom-plugin/index.md) — Build your own plugins

---

[← Back to Plugins](../index.md) | [Next: Usage Patterns →](./patterns.md)
