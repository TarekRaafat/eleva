...
> **Version:** 1.0.0-rc.12 | **Generated:** 1/9/2026, 12:10:09 AM | **Platform:** darwin arm64 | **Runtime:** Bun 1.3.5
...
| Hydration Time | 0.185 ms | **< 1** |
| DOM Update | 0.039 ms | **< 0.1** |
| Memory | < 0.5 MB | **< 0.5** |
...
|-------|------|
| ESM (raw) | 52.80 KB |
| UMD (minified) | 5.83 KB |
| UMD (min+gzip) | **2.31 KB** |
